...
public class HttpTaskManager extends FileBackedTasksManager {
    ...
    private void load() {
        ...
        ArrayList<Task> loadedTasks = gson.fromJson(jsonTasks, new TypeToken<List<Task>>() {
        }.getType());
        if (loadedTasks != null) {
        ...
        ArrayList<Epic> loadedEpics = gson.fromJson(jsonEpics, new TypeToken<List<Epic>>() {
        }.getType());
        if (loadedEpics != null) {
        ...
        ArrayList<Subtask> loadedSubtasks = gson.fromJson(jsonSubtasks, new TypeToken<List<Subtask>>() {
        }.getType());
        ...
        ArrayList<Integer> loadedHistoryIds = gson.fromJson(jsonHistory, new TypeToken<List<Integer>>() {
        }.getType());
        if (loadedHistoryIds != null) {
            for (Integer id : loadedHistoryIds) {
